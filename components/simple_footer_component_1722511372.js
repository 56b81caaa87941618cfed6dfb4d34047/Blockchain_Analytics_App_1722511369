...
*/
Vue.component("simple_footer_component_1722511372", {
    template: `
    <footer id="footer-section" class="flex-1 bg-gradient-to-r from-pink-500 to-purple-600 backdrop-filter backdrop-blur-lg bg-opacity-30 border border-pink-300 rounded-lg shadow-lg">
            <div id="footer-container" class="max-w-screen-xl p-8 py-10 mx-auto lg:py-16 md:p-12 lg:p-14">
                ...
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-lg text-center text-white">
                        Unlock valuable insights from blockchain data with our powerful analytics tools. Stay ahead of the curve in the ever-evolving world of decentralized technology.
                    </div>
                </div>
            </div>
        </footer> 
